...
// Added
  _onTimeOut: function() {  // <-- NEW SECTION ******************************************
	...
	var request = this;
	var timeout = this.options.onTimeOut;
	var func= function() { timeout(request);};
...
// End Added
  ...
  respondToReadyState: function(readyState) {
    ...
    if (state == 'Complete') {
      try {
        this._complete = true;
		 // <-- NEW LINE *****************************
		if(this._onTimerOutHand) clearTimeout(this._onTimerOutHand);
		 // <-- NEW LINE *****************************
  ...
  abort: function() {
	...
	//clear the timeout handler, if it exists
	if(this._onTimerOutHand) clearTimeout(this._onTimerOutHand);
